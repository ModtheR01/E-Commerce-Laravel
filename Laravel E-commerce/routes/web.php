...
Route::middleware(['localeSessionRedirect', 'localizationRedirect', 'localeViewPath'])->prefix(LaravelLocalization::setLocale())->group(function () {
        ...
        Route::controller(HomeController::class)->name('front.')->group(function () {
            ...
            Route::get('/shop', [DashboardProduct::class, 'shop'])->name('shop');
            Route::get('/single_shop/{id}', [DashboardProduct::class, 'singleProduct'])->name('single_shop');
            Route::get('/single_category/{id}', [DashboardProduct::class, 'singleCategory'])->name('single_category');
